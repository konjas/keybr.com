...
//
////////////////////////////////////
import { LANGUAGE_MAP } from "./index.ts";
import { CODEMAP, KEYALIASES, KEYMAP } from "./keygen.js";
import { addInitializer } from "./util.js";
...
addInitializer("load", () => {
  ...
  KEY.generateAllKeycodes = () => {
    ...
    for (let i = 0; i < 64; i++) {
      const userkey = "USER" + String(i).padStart(2, "0");
